...
marcar o botão como selecionado e mostrar o personagem correspondente
    ...
    OBJETIVO 1 - quando clicar no botão do personagem na lista, marcar o botao como selecionado 
        ...
        passo 3 -  passo 2 - adicionar a classe "selecionado" no botão que o usuário clicou 
...
const botoes = document.querySelectorAll(".botao");
    ...
    botoes.forEach((botao, indice) => {
        botao.addEventListener("click", () => {
            ...
            dessacelecionarBotao();   
            dessecelecionarpersonagem();
...
function dessecelecionarpersonagem() {
    const personagemSelecionado = document.querySelector(".personagem.selecionado");
    personagemSelecionado.classList.remove("selecionado");
}

function dessacelecionarBotao() {
